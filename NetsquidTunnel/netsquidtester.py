...
SCTP_PORT = 38472
BUFFER_SIZE = 128384
POLL_INTERVAL = 1000000  # Polling interval (ns)
...
class QCUNode(Node):
    ...
    def process_cu_message(self, message):
        ...
        qcu_processing_delay = 6000000000  # 6 seconds processing delay (for 110-120ms RTT)
    ...
    def handle_message_from_qdu(self, message):
        ...
        qcu_processing_delay = 6000000000  # 6 seconds QCU processing delay (for 110-120ms RTT)
...
class QDUNode(Node):
    ...
    def process_du_message(self, message):
        ...
        qdu_processing_delay = 6000000000  # 6 seconds processing delay (for 110-120ms RTT)
    ...
    def handle_message_from_qcu(self, message):
        ...
        qdu_processing_delay = 6000000000  # 6 seconds QDU processing delay (for 110-120ms RTT)
